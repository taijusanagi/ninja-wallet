...
export interface GitcoinPassportPaymasterInterface extends utils.Interface {
  functions: {
    "addStake(uint32)": FunctionFragment;
    "deposit()": FunctionFragment;
    "entryPoint()": FunctionFragment;
    "getDeposit()": FunctionFragment;
    "gitcoinPassportUserId()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "gitcoinPassportUserId",
    values?: undefined
  ): string;
...
export interface GitcoinPassportPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GitcoinPassportPaymasterInterface;
  ...
  functions: {
    ...
    gitcoinPassportUserId(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    gitcoinPassportUserId(overrides?: CallOverrides): Promise<BigNumber>;
