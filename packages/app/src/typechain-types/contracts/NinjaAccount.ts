...
export interface NinjaAccountInterface extends utils.Interface {
  functions: {
    "entryPoint()": FunctionFragment;
    "execute(address,uint256,bytes)": FunctionFragment;
    "getNonce()": FunctionFragment;
    "initialize(uint256,bytes16[])": FunctionFragment;
    "isGroupIdIncluded(bytes16)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isGroupIdIncluded",
...
export interface NinjaAccount extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NinjaAccountInterface;
  ...
  functions: {
    ...
    initialize(
      ...
      _groupIds: PromiseOrValue<BytesLike>[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
